    ...
    <> 
      ...
      <div className="bg-white hover:cursor-pointer rounded-tl-2xl shadow-2xl card-container h-[max-content] rounded-br-2xl rounded-tr-4xl rounded-bl-4xl ml-[2%] "> 
          <div className="content  p-4 mt-6">
            <h1 className="mb-22 text-xl capitalize hover:border-b-2 w-[max-content] duration-300 ">   🚚 Free Delivery
...
Let me know if you need any tweaks! 😊
        ...
        <div className="bg-white hover:cursor-pointer rounded-tl-2xl shadow-2xl card-container h-[max-content] rounded-br-2xl rounded-tr-4xl pb-6 rounded-bl-4xl ml-[2%] "> 
          <div className="content  p-4 mt-6 ">
            <h1 className="mb-22 text-xl capitalize hover:border-b-2 w-[max-content] duration-300 ">  💧 Mineral Water
            </h1>
            <p>
...
Let me know if you need any adjustments! 😊
        ...
        <div className="bg-white hover:cursor-pointer sm:mr-4 rounded-tl-2xl shadow-2xl h-[max-content] card-container rounded-br-2xl rounded-tr-4xl rounded-bl-4xl ml-[2%] ">
          <div className="content p-4  mt-10">
            <h1 className="text-xl mb-18   capitalize hover:border-b-2 w-[max-content] duration-300 ">               💰 Retail Price
            </h1>
            <p className="mb-6 ">
